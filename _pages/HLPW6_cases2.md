...
## Test Cases
Test cases define the collaborative problems that are worked through the Technical Focus Groups. Cases for this workshop include both a simplified, extruded wing section of the CRM-HL, and the full fidelity CRM-HL definition. These cases are completly described in the document below, and shown on this page as a reference.
...
![CRM-HLS](assets/img/CRM_HLS.png)
