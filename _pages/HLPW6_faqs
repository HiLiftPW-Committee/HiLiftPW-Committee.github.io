...
A8: For HLPW-5, there are 3 test cases that are being tackled by the TFGs sequentially, and several virtual meetings will likely be held prior to the final workshop in order to discuss the results and progress. Tentative dates are listed on the home page (HLPW-5 home page). Each TFG will likely define its own internal deadlines as well. Participants should also have an opportunity to refine their computations prior to the final deadline for HLPW-5.

 
Q9: What should I do if I find "problem areas" in the geometry files?
A9: If you encounter any problems/issues as you build grids using the geometry files, please make your own fixes, DOCUMENT everything done, and plan to share your fixes with your TFG. Note that the geometry includes regions that may be very difficult to grid (and possibly solve), including very thin gaps at the bottom/inside edge of the slats. These were present in the wind tunnel configuration, so they were left in. It is up to you how to handle such areas; this is part of the challenge of the workshop. Again, be sure to document every assumption/change/fix that you make, as your grids are created.

 
Q10: It is confusing that the test cases use full-scale geometry yet wind-tunnel-scale Reynolds number (Re). How do I reconcile this, and how do I set Re if my code does not have Re as an input?
...
Q11: Where can I find gridding guidelines for making my own meshes?
